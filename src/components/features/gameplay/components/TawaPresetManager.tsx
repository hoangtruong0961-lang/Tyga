                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="flex flex-col gap-1">
                        <label className="text-sm font-semibold text-stone-700 dark:text-slate-300">
                          Reasoning Effort
                        </label>
                        <select
                          className="w-full bg-stone-50 dark:bg-slate-900 border border-stone-300 dark:border-slate-700 rounded-lg px-3 py-2 text-sm text-stone-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-mystic-accent"
                          value={config.aiConfigOverrides?.reasoningEffort || "none"}
                          onChange={(e) =>
                            updateConfig((c) => ({
                              ...c,
                              aiConfigOverrides: {
                                ...(c.aiConfigOverrides || {}),
                                reasoningEffort: e.target.value === "none" ? undefined : e.target.value,
                              }
                            }))
                          }
                        >
                          <option value="none">[Không sử dụng (Mặc định)]</option>
                          <option value="auto">Auto (Mô hình tự phân bổ)</option>
                          <option value="min">Min (Flash 2.5 - 0 tokens)</option>
                          <option value="low">Low (10% tokens)</option>
                          <option value="medium">Medium (25% tokens)</option>
                          <option value="high">High (50% tokens)</option>
                          <option value="max">Max (Tối đa tokens)</option>
                        </select>
                        <p className="text-xs text-stone-500 dark:text-slate-500 mt-1">
                          Sets a dynamic reasoning depth level. Auto lets the model decide.
                        </p>
                      </div>
                    </div>
                    <div className="flex flex-col gap-1.5 p-3 bg-slate-900/50 rounded-lg border border-slate-800 text-xs text-slate-400">
                      ...
                      <ul className="list-disc pl-4 space-y-1">
                        ...
                        <li><strong>Reasoning Effort:</strong> Hỗ trợ thiết lập linh hoạt mức độ suy nghĩ cho Flash/Pro 3.0 mà không cần fix cứng budget.</li>
