...
3. Hợp nhất thành bản đồ ký ức cực kỳ chi tiết, không giới hạn độ dài, giữ lại mọi tình tiết quan trọng.
...
Viết dưới dạng đoạn văn chi tiết, đầy đủ mọi sự kiện, tình tiết nhỏ trọn vẹn nhất có thể, nhớ thật dai và đầy đủ.
