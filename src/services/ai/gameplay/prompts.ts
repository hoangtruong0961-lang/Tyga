...
(CẢNH BÁO TỬ THẦN: Bạn chỉ được thực hiện quy trình này MỘT LẦN DUY NHẤT trong thẻ <thinking> khối đầu tiên. Nghiêm cấm bật lại thẻ <thinking> khi đã bắt đầu viết <content>!)`;
    }
...
5. **KỶ LUẬT SUY NGHĨ TRONG <thinking> (SILENT LOGIC AUDIT)**:
   - Ở đầu block <thinking> của turn chat này, bạn PHẢI thực hiện rà soát riêng theo cấu trúc:
     ...
     - Kế hoạch biến chuyển (Nếu thiếu hụt/bị cấm, hoặc để duy trì nhất quán trạng thái vật chất/vũ khí đang giữ, sẽ viết diễn biến Thất bại/Kháng cự bế tắc/Hậu quả hay Đảm bảo vật lý trực quan như thế nào?): ...
     \`\`\`
</KNOWLEDGE_LOGIC_INTEGRITY_LAWS>`,
